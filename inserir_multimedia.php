...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO multimedia (titulo, data, tipologia, foto)
VALUES ('$titulo', '$data', '$tipologia', '$fpasta')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Conteúdo Multimédia</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-4" name="titulo" style="color: #BABBBC; font-family: avalors;">

                        <label>
                            <p7>Data</p7>
                        </label>
                        <input type="date" class="form-control mb-4" name="data" style="color: #BABBBC; font-family: avalors;">
