...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO resultados (equipa_casa, local, data, hora, competicao, escalao, resultado_final)
VALUES ('$fpasta', '$local', '$data', '$hora', '$competicao', '$escalao', '$resultado_final')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Resultado Final</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-4" name="local" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO----------------------------->
                        <label>
                            <p7>Data</p7>
                        </label>
                        <input type="date" class="form-control mb-4" name="data" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO DE SÓCIO----------------------------->
                        <label>
                            <p7>Hora</p7>
                        </label>
                        <input type="time" class="form-control mb-4" name="hora" style="color:#BABBBC; font-family: avalors;" required>
                        <label>
                            <p7>Competição</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="competicao" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO----------------------------->
                        <label>
                            <p7>Escalão</p7>
                        </label>
                        ...
                        </select> <!---------------PREÇO DE SÓCIO----------------------------->
                        <p></p>
                        <label>
                            <p7>Resultado</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="resultado" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------FOTO----------------------------->
                        <!---------------BOTÕES----------------------------->
                        <div class="row">
                            <div class="col-4"></div>
