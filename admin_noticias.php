...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12">
                <center>
                    <p>
                        <a href="inserir_noticia.php">
                            <p4>Adicionar Notícia</p4>
                        </a>
                    </p>
                </center>
            </div>
    ...
    <div class="container mb-2 mt-5">
        <div class="row">
            <div class="col-12">
                <?php
                $consulta = "SELECT * FROM noticias Order by id ";
                    ...
                    <table class='table'>
                        ...
                        ?>
                            ...
                            <tbody>
                                <tr>
                                    <th width="200">
                                        <P15><img src="<?php echo $row['foto'] ?>" alt="..." class="img-fluid img-thumbnail w-50 align-middle"></P15>
                                    </th>

                                    <th class="align-middle">
                                        <P15><?php echo $row['titulo']; ?></P15>
                                    </th>
                                    <th class="align-middle">
                                        <center>
                                            <P15><?php echo $row['subtitulo']; ?></P15>
                                        </center>
                                    </th>
                                    <th class="align-middle">
                                        <center>
                                    ...
                                    <th scope="row" class="align-middle">
                                        <center>
                                            ...
                                            <a href="apagar_noticia.php?id=<?php echo $row['id'] ?>">
