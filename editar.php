...
<body>
    ...
    ?>
            <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
                <center>
                    <p4 class="display-4">Produto <?php echo $row['id'] ?></p4>
                </center>
            </div>
            ...
            <div class="container mb-5 mt-5">
                <div class="row">
                    <div class="col-12 mb-5">
                        <form action="validar_editar.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4" name="preco_socio" value="<?php echo $row['preco_socio'] ?>" style="color: #BABBBC; font-family: avalors;">

                                <label>
                                    <p7>Stock</p7>
                                </label>
                                <input type="text" class="form-control mb-4" name="stock" value="<?php echo $row['stock'] ?>" style="color: #BABBBC; font-family: avalors;">

                                <label>
                                    <p7>Referência</p7>
                                </label>
                                <input type="text" class="form-control mb-4" name="referencia" value="<?php echo $row['referencia'] ?>" style="color: #BABBBC; font-family: avalors;">
