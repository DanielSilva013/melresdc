...
<body>
    ...
    ?>
            <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
                <center>
                    <p4 class="display-4">Editar Animação Jogador <?php echo $row['id'] ?></p4>
                </center>
            </div>
            ...
            <div class="container mb-5 mt-5">
                <div class="row">
                    <div class="col-12 mb-5">
                        <form action="validar_editar_jogador_hover.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control mb-4" name="camisola" value="<?php echo $row['camisola'] ?>" style="color: #BABBBC; font-family: avalors;" readonly>

                                <label>
                                    <p7>Nome</p7>
                                </label>
                                <input type="text" class="form-control mb-4" name="nome" value="<?php echo $row['nome'] ?>" style="color: #BABBBC; font-family: avalors;" readonly>
                               
                                <label>
                                    <p7>Categoria</p7>
                                </label>
                                <input type="text" class="form-control mb-4" name="posicao" value="<?php echo $row['posicao'] ?>" style="color: #BABBBC; font-family: avalors;" readonly>

                                <label>
                                    <p7>Posição</p7>
                                </label>
                                <input type="text" class="form-control mb-4" name="posicaoesp" value="<?php echo $row['posicao_especifica'] ?>" style="color: #BABBBC; font-family: avalors;" readonly>
                                <label>
                                    <p7>Foto Hover</p7>
                                </label>
