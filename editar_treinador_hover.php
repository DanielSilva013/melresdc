...
<body>
    ...
    ?>
            <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
                <center>
                    <p4 class="display-4">Editar Animação Treinador <?php echo $row['id'] ?></p4>
                </center>
            </div>
            ...
            <div class="container mb-5 mt-5">
                <div class="row">
                    <div class="col-12 mb-5">
                        <form action="validareditartreinadorhv.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4" name="cargo" value="<?php echo $row['posicao_especifica'] ?>" style="color: #BABBBC; font-family: avalors;" readonly>
