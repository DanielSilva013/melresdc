...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO bilheteira (casa, local, data, hora, competicao, escalao, preco)
VALUES ('$fpasta', '$local', '$data', '$hora', '$competicao', '$escalao', '$preco')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Jogo</p4>
        </center>
    </div>
