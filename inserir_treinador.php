...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO plantel (nome, posicao, posicao_especifica, foto)
VALUES ('$nome', '$posicao', '$posicao_especifica', '$fpasta')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Treinador</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-4" name="posicao" style="color:#BABBBC; font-family: avalors;" value="Treinador" placeholder="Treinador" readonly>
