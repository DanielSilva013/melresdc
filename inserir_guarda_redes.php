...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO gr (nome, camisola, posicao, minutos, jogos, defesas, cleansheets, descricao, foto)
VALUES ('$nome', '$camisola','$posicao', '$minutos', '$jogos', '$defesas', '$cleansheets', '$descricao', '$fpasta')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Jogador</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-4" name="posicao" style="color:#BABBBC; font-family: avalors;" value="Guarda-Redes" readonly>
                        ...
                        <input type="number" class="form-control mb-4" name="defesas" style="color:#BABBBC; font-family: avalors;" required>

                        <label>
                            <p7>Cleansheets</p7>
                        </label>
                        <input type="number" class="form-control mb-4" name="cleansheets" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------FOTO----------------------------->
                        <label>
                            <p7>Descrição</p7>
                        </label>
