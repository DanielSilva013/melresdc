...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO agenda (hora, dia, local, evento, categoria)
VALUES ('$hora', '$dia', '$local', '$evento', '$categoria')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Evento</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-4" name="dia" style="color:#BABBBC; font-family: avalors;" required>
                        <label>
                            <p7>Local</p7>
                        </label>
                        ...
                        <input type="text" class="form-control mb-4" name="evento" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------FOTO----------------------------->
                        <label>
                            <p7>Categoria</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="categoria" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------BOTÕES----------------------------->
                        <div class="row">
                            <div class="col-4"></div>
                            <div class="col-2">
