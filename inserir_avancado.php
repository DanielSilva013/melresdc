...
if (isset($_POST['submitform'])) {
    ...
    $posicao_especifica = $_POST['posicao_especifica'];
    ...
    $inserir = "INSERT INTO plantel (nome, camisola, posicao, posicao_especifica, minutos, jogos, golos, assistencias, descricao, foto)
VALUES ('$nome', '$camisola','$posicao', '$posicao_especifica', '$minutos', '$jogos', '$golos', '$assistencias', '$descricao', '$fpasta')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Avançado</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control mb-4" name="camisola" style="color:#BABBBC; font-family: avalors;" required>

                        <label>
                            <p7>Categoria</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="posicao" style="color:#BABBBC; font-family: avalors;" value="Avançado" readonly>

                        <label>
                            <p7>Posição</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="posicao_especifica" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO DE SÓCIO----------------------------->

                        <label>
                            <p7>Minutos</p7>
                        </label>
                        <input type="number" class="form-control mb-4" name="minutos" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO----------------------------->
                        <label>
                            <p7>Jogos</p7>
                        </label>
                        <input type="number" class="form-control mb-4" name="jogos" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO DE SÓCIO----------------------------->
                        <label>
                            <p7>Golos</p7>
                        </label>
                        <input type="number" class="form-control mb-4" name="golos" style="color:#BABBBC; font-family: avalors;" required>

                        <label>
                            <p7>Assistências</p7>
                        </label>
                        <input type="number" class="form-control mb-4" name="assistencias" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------FOTO----------------------------->
                        <label>
                            <p7>Descrição</p7>
                        </label>
