...
<body>
    ...
    ?>
            <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
                <center>
                    <p4 class="display-4">Editar Notícia <?php echo $row['id'] ?></p4>
                </center>
            </div>
            ...
            <div class="container mb-5 mt-5">
                <div class="row">
                    <div class="col-12 mb-5">
                        <form action="validar_editar_noticia.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" rows="2" class="form-control mb-4" name="titulo" value="<?php echo $row['titulo'] ?>" style="color: #BABBBC; font-family: avalors;">

                                <label>
                                    <p7>Subtítulo</p7>
                                </label>
                                <input type="text" class="form-control mb-4" name="subtitulo" value="<?php echo $row['subtitulo'] ?>" style="color: #BABBBC; font-family: avalors;">
                                ...
                                <input type="file" class="form-control" name="uploadfile" style="color: #BABBBC; font-family: avalors;">
                                <p></p>
                                <div class="row">
                                    <div class="col-4"></div>
                                    <div class="col-2">
