...
<body>
                    ...
                    <table width="1296px" bgcolor="#FED969" height="40px">
                        <tr>
                            <td>
                                <center>
                                    <p>
                                    <h6>Pedidos de Adesão de Sócio</h6>
                                    </p>
                                </center>
                            </td>
                        </tr>
    ...
    <div class="container mb-2 mt-5">
        <div class="row">
            <div class="col-12">
                <?php
                $consulta = "SELECT * FROM inscricao_socio Order by id ";
                        ...
                        ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th class="align-middle">
                                        <center>
                                            <P2><?php echo $row['data_nascimento']; ?></P2>
                                        </center>
                                    </th>

                                    <th scope="row" class="align-middle">
                                        <center>
                                            <a href="apagar_socio.php?id=<?php echo $row['id'] ?>">
