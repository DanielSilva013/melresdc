...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12">
                <center>
                    <p>
                        <a href="inserir_encomenda.php">
                            <p4>Adicionar Encomenda</p4>
                        </a>
                    </p>
                </center>
            </div>
    ...
    <div class="container mb-2 mt-5">
        <div class="row">
            <div class="col-12">
                <?php
                $consulta = "SELECT * FROM encomendas Order by id ";
