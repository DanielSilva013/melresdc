...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO noticias (titulo, subtitulo, descricao, data, foto)
VALUES ('$titulo', '$subtitulo', '$descricao', '$data' , '$fpasta')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Notícia</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-4" name="titulo" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO----------------------------->
                        <label>
                            <p7>Subtítulo</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="subtitulo" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO DE SÓCIO----------------------------->
                        <label>
                            <p7>Descrição</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="descricao" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------FOTO----------------------------->
                        <label>
                            <p7>Data</p7>
                        </label>
