...
if (isset($_POST['submitform'])) {
    ...
    $inserir = "INSERT INTO encomendas (encomenda, estado, preco, foto, data, utilizador, id_utilizador)
VALUES ('$encomenda', '$estado', '$preco', '$fpasta', '$data', '$utilizador', '$id_utilizador')";
...
<body>
    ...
    <div style="background: url(Imagens/Plantel/Banner_Jogador.jpg) ; padding:50px;">
        <center>
            <p4 class="display-4">Adicionar Encomenda</p4>
        </center>
    </div>
            ...
            <div class="col-12 mb-5">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-4" name="encomenda" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------PREÇO----------------------------->
                        <label>
                            <p7>Estado</p7>
                        </label>
                        ...
                        <input type="text" class="form-control mb-4" name="utilizador" style="color:#BABBBC; font-family: avalors;" required>
                        <label>
                            <p7>ID de Utilizador</p7>
                        </label>
                        <input type="text" class="form-control mb-4" name="id_user" style="color:#BABBBC; font-family: avalors;" required>
                        <!---------------FOTO----------------------------->
                        <label>
                            <p7>Foto</p7>
                        </label>
